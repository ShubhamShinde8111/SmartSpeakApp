...
public class MainActivity extends AppCompatActivity {
    ...
    private View micCard; // Card to trigger speech practice
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roleInputField = findViewById(R.id.role_input);
        continueButton = findViewById(R.id.continue_button);
        // micCard = findViewById(R.id.micCard); // Finding the micCard from XML
        ...
        if (micCard != null) {
            micCard.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(MainActivity.this, SpeechPracticeActivity.class);
