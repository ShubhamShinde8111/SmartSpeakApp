...
public class MeaningAdapter extends RecyclerView.Adapter<MeaningAdapter.MeaningViewHolder> {
    ...
    public static class MeaningViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Meaning meaning) {
            ...
            if (meaning.getSynonyms() == null || meaning.getSynonyms().isEmpty()) {
                binding.synonymsLayout.setVisibility(View.GONE);
            } else {
                binding.synonymsLayout.setVisibility(View.VISIBLE);
            ...
            if (meaning.getAntonyms() == null || meaning.getAntonyms().isEmpty()) {
                binding.antonymsLayout.setVisibility(View.GONE);
            } else {
                binding.antonymsLayout.setVisibility(View.VISIBLE);
    ...
    public MeaningViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MeaningRecyclerRowBinding binding = MeaningRecyclerRowBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false);
